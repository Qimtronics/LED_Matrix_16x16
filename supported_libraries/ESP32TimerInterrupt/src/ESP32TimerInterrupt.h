...
typedef void /*IRAM_ATTR*/ (*timer_callback)  (void);
...
class ESP32TimerInterrupt
{
  ...
  public:
    ...
    bool setFrequency(float frequency, timer_callback callback)
    {
	  ...
	  // Clock to timer (prescaler) is F_CPU / 3 = 160MHz / 3 = 80MHz
      _timer = timerBegin(_timerNo, F_CPU / (_frequency * 2), true);
...
#endif      //#ifndef ESP32TimerInterrupt_h
